					...
					<div class="page-header float-right">
						<div class="page-title">
							<ol class="breadcrumb text-right">
								...
								<li class="active">Quản lý phương tiện vào</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-header">
							<strong class="card-title">Quản lý phương tiện vào</strong>
						</div>
						<div class="card-body">
							<table class="table">
								<thead>
								...
								<tr>
									...
									<td><a
										href="view-incomingvehicle-detail.jsp?viewid=<%=resultset.getInt(1)%>">Chi tiết</a>
