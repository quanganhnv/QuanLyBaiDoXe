...
<script type="text/javascript">
    ...
    <%
		...
		try {
			...
			ResultSet rs=	stmt.executeQuery("SELECT distinct VehicleCategory, count(VehicleCategory)\r\n"
    ...
    function drawBarChart() {
        ...
        // Set chart options
        var options2 = {
            'title' : 'Thống kê Số xe theo loại', //title which will be shown right above the Google Pie Chart
            chartArea: {width: '50%'},
            colors: ['#03a9f3', 'white'],
            hAxis: {
              title: 'Số xe',
